...
const SVGComponent: React.FC = () => {
    ...
    const nuwaraEliyaData = {
        ...
        imageLocation: "/placeholder.svg?height=400&width=800"
      };
        ...
        <div className='relative'>
            ...
            >
                ...
                <path
                    ...
                    {/* Golf Flag Marker with more precise positioning */}
                    <g 
                        onClick={() => handleClick('Nuwaraeliya')}
          ...
          <InfoCard 
            title={nuwaraEliyaData.title}
            description={nuwaraEliyaData.description}
            activities={nuwaraEliyaData.activities}
            isVisible={selectedRegion === 'Nuwaraeliya'}
            imageLocation={nuwaraEliyaData.imageLocation}
          />
        </div>
        </div>
    );
