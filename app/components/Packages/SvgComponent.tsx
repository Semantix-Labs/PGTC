...
const SVGComponent: React.FC = () => {
    ...
    const [hoveredRegion, setHoveredRegion] = useState('close');

    const handleClick = (pathId: string) => {
        console.log(`Clicked on path with ID: ${pathId}`);
        setSelectedRegion(pathId);
    };

    const handleSVGClick = (event: React.MouseEvent<SVGSVGElement>) => {
        // Check if the click was on an empty area (not on a path or flag)
        if (event.target === event.currentTarget) {
            setSelectedRegion('close');
            setHoveredRegion('close');
        }
    };

    const handleMouseEnter = (pathId: string) => {
        setHoveredRegion(pathId);
    };
    ...
    const getPathStyle = (pathId: string) => {
        const isSelected = selectedRegion === pathId;
        const isHovered = hoveredRegion === pathId;
        return {
            cursor: 'pointer',
            stroke: 'white',
            strokeWidth: 0,
            fill: isSelected ? '#2E5339' : (isHovered ? '#E6ECDE' : '#2E5339'),
    ...
    const locationData = [
        {
            ...
            description: "Nuwara Eliya features cool weather year-round (16°C-20°C), chilly nights (5°C-10°C), moderate humidity (70%-90%), annual rainfall (~2,000mm), with dry (Jan-Apr) and monsoons (May-Dec).",
            activities: [
                "Boating",
                "Cycling",
                "Farm Visit",
        ...
        {
            id: 'colombo',
            title: "Golf In Colombo",
            description: "Colombo features warm weather year-round (27°C-31°C), mild nights (24°C-26°C), high humidity (75%-90%), annual rainfall (2,500mm), with dry (Jan-March) & wet (April-Dec).",
            activities: [
                "Boating",
                "Cycling",
                "Street Food",
        ...
        {
            id: 'hambantota',
            title: "Golf In Hambantota",
            description: "Hambantota features warm weather year-round (27°C-32°C), mild nights (22°C-26°C), low humidity (60%-80%), annual rainfall (1,000mm), with dry (May-Sept) & rainy (Oct-Apr).",
            activities: [
                "Boating",
                "Cycling",
                "Fishing",
    ...
    return (
        <div className={`relative max-w-7xl mx-auto md:py-20 `}>
            ...
            >
                ...
                <g
                    onClick={() => handleClick('colombo')}
                    onMouseEnter={() => handleMouseEnter('colombo')}
                ...
                <g>
                    ...
                    <path
                        ...
                        id="LK-12"
                        fill='#2E5339'
                        onClick={() => handleClick('path2')}
                        style={{
                            cursor: 'pointer', stroke: 'white',
                            strokeWidth: 0,
                        }}
                    />
                </g>
                <g    onClick={() => handleClick('colombo')}
                    onMouseEnter={() => handleMouseEnter('colombo')}
                    onMouseLeave={handleMouseLeave}
                    style={{ cursor: 'pointer' }}
                    >
                ...
                <svg
                    ...
                    height="80"
                    viewBox="0 0 32 32"
                    fill={selectedRegion === 'colombo' ? '#C7A041' : (hoveredRegion === 'colombo' ? '#C7A041' : '#f70202')}
                    stroke={selectedRegion === 'colombo' ? '#C7A041' : (hoveredRegion === 'colombo' ? '#C7A041' : '#f70202')}
                    strokeWidth="2"
                    strokeLinecap="round"
...
<g id="SVGRepo_iconCarrier"> <title/> <g data-name="Layer 12" id="Layer_12"> <path d="M16,17a5,5,0,1,0-5-5A5,5,0,0,0,16,17Zm0-8a3,3,0,1,1-3,3A3,3,0,0,1,16,9Z"/> <path d="M22.72,20.57C24.89,16.78,26,13.89,26,12A10,10,0,0,0,6,12c0,1.89,1.11,4.78,3.28,8.57C6.33,21.09,2,22.32,2,25c0,3.44,7.26,5,14,5s14-1.56,14-5C30,22.32,25.67,21.09,22.72,20.57ZM16,4a8,8,0,0,1,8,8c0,1.68-1.33,4.81-3.74,8.82-.18.3-.36.6-.55.9,0,.08-.09.15-.13.22l-.45.71a1.74,1.74,0,0,1-.11.18c-.37.58-.74,1.15-1.09,1.67l-.08.12-.45.67-.07.1c-.33.49-.64.94-.91,1.32l-.06.08-.32.46,0,.05,0-.05c-.49-.68-1.14-1.61-1.87-2.7h0c-.35-.54-.73-1.11-1.11-1.71l-.12-.19L12.44,22l-.17-.27-.42-.7-.11-.18h0C9.33,16.81,8,13.68,8,12A8,8,0,0,1,16,4ZM4,25c0-.59,1.88-1.91,6.36-2.59l0,.05.42.67.07.12.46.73,0,0c.32.51.65,1,1,1.48l0,0,.43.64.08.11.35.52.07.1.34.5.05.06L14,28C7.75,27.65,4,26,4,25ZM18,28l.34-.48.05-.08.34-.49.07-.1.34-.5.1-.14.35-.53.1-.15c.31-.46.62-.94.94-1.45l.11-.16.37-.59.16-.26.32-.52.06-.09c4.48.68,6.36,2,6.36,2.59C28,26,24.25,27.65,18,28Z"/> </g> </g>
                ...
                <path
                    ...
                    onClick={() => handleClick('kandy')}
                    onMouseEnter={() => handleMouseEnter('kandy')}
                    onMouseLeave={handleMouseLeave}
                   
                    id="LK-21"
                    fill='#2E5339'
                    style={getPathStyle('kandy')} />
                <path
                ...
                >
                    <svg
                        ...
                        height="80"
                        viewBox="0 0 32 32"
                        fill={selectedRegion === 'kandy' ? '#C7A041' : (hoveredRegion === 'kandy' ? '#C7A041' : '#f70202')}
                        stroke={selectedRegion === 'kandy' ? '#C7A041' : (hoveredRegion === 'kandy' ? '#C7A041' : '#f70202')}
                        strokeWidth="2"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                    >
...
<g id="SVGRepo_iconCarrier"> <title/> <g data-name="Layer 12" id="Layer_12"> <path d="M16,17a5,5,0,1,0-5-5A5,5,0,0,0,16,17Zm0-8a3,3,0,1,1-3,3A3,3,0,0,1,16,9Z"/> <path d="M22.72,20.57C24.89,16.78,26,13.89,26,12A10,10,0,0,0,6,12c0,1.89,1.11,4.78,3.28,8.57C6.33,21.09,2,22.32,2,25c0,3.44,7.26,5,14,5s14-1.56,14-5C30,22.32,25.67,21.09,22.72,20.57ZM16,4a8,8,0,0,1,8,8c0,1.68-1.33,4.81-3.74,8.82-.18.3-.36.6-.55.9,0,.08-.09.15-.13.22l-.45.71a1.74,1.74,0,0,1-.11.18c-.37.58-.74,1.15-1.09,1.67l-.08.12-.45.67-.07.1c-.33.49-.64.94-.91,1.32l-.06.08-.32.46,0,.05,0-.05c-.49-.68-1.14-1.61-1.87-2.7h0c-.35-.54-.73-1.11-1.11-1.71l-.12-.19L12.44,22l-.17-.27-.42-.7-.11-.18h0C9.33,16.81,8,13.68,8,12A8,8,0,0,1,16,4ZM4,25c0-.59,1.88-1.91,6.36-2.59l0,.05.42.67.07.12.46.73,0,0c.32.51.65,1,1,1.48l0,0,.43.64.08.11.35.52.07.1.34.5.05.06L14,28C7.75,27.65,4,26,4,25ZM18,28l.34-.48.05-.08.34-.49.07-.1.34-.5.1-.14.35-.53.1-.15c.31-.46.62-.94.94-1.45l.11-.16.37-.59.16-.26.32-.52.06-.09c4.48.68,6.36,2,6.36,2.59C28,26,24.25,27.65,18,28Z"/> </g> </g>
                ...
                <g>
                    ...
                    <path
                        ...
                        onClick={() => handleClick('Nuwaraeliya')}
                        onMouseEnter={() => handleMouseEnter('Nuwaraeliya')}
                        onMouseLeave={handleMouseLeave}

                        style={getPathStyle('Nuwaraeliya')}
                        id="LK-23"
                    />

                    {/* Nuwara Eliya Golf Flag Marker */}
                    <g
                        onClick={() => handleClick('Nuwaraeliya')}
                        onMouseEnter={() => handleMouseEnter('Nuwaraeliya')}
                        onMouseLeave={handleMouseLeave}
                    ...
                    >
                       <svg   x="185"
                            ...
                            width="55"
                            height="80"
                            viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"  fill={selectedRegion === 'Nuwaraeliya' ? '#C7A041' : (hoveredRegion === 'Nuwaraeliya' ? '#C7A041' : '#f70202')}
                        stroke={selectedRegion === 'Nuwaraeliya' ? '#C7A041' : (hoveredRegion === 'Nuwaraeliya' ? '#C7A041' : '#f70202')}>
...
<g id="SVGRepo_iconCarrier"> <title/> <g data-name="Layer 12" id="Layer_12"> <path d="M16,17a5,5,0,1,0-5-5A5,5,0,0,0,16,17Zm0-8a3,3,0,1,1-3,3A3,3,0,0,1,16,9Z"/> <path d="M22.72,20.57C24.89,16.78,26,13.89,26,12A10,10,0,0,0,6,12c0,1.89,1.11,4.78,3.28,8.57C6.33,21.09,2,22.32,2,25c0,3.44,7.26,5,14,5s14-1.56,14-5C30,22.32,25.67,21.09,22.72,20.57ZM16,4a8,8,0,0,1,8,8c0,1.68-1.33,4.81-3.74,8.82-.18.3-.36.6-.55.9,0,.08-.09.15-.13.22l-.45.71a1.74,1.74,0,0,1-.11.18c-.37.58-.74,1.15-1.09,1.67l-.08.12-.45.67-.07.1c-.33.49-.64.94-.91,1.32l-.06.08-.32.46,0,.05,0-.05c-.49-.68-1.14-1.61-1.87-2.7h0c-.35-.54-.73-1.11-1.11-1.71l-.12-.19L12.44,22l-.17-.27-.42-.7-.11-.18h0C9.33,16.81,8,13.68,8,12A8,8,0,0,1,16,4ZM4,25c0-.59,1.88-1.91,6.36-2.59l0,.05.42.67.07.12.46.73,0,0c.32.51.65,1,1,1.48l0,0,.43.64.08.11.35.52.07.1.34.5.05.06L14,28C7.75,27.65,4,26,4,25ZM18,28l.34-.48.05-.08.34-.49.07-.1.34-.5.1-.14.35-.53.1-.15c.31-.46.62-.94.94-1.45l.11-.16.37-.59.16-.26.32-.52.06-.09c4.48.68,6.36,2,6.36,2.59C28,26,24.25,27.65,18,28Z"/> </g> </g>
                ...
                <g
                    onClick={() => handleClick('hambantota')}
                    onMouseEnter={() => handleMouseEnter('hambantota')}
                    onMouseLeave={handleMouseLeave}
                    style={{ cursor: 'pointer' }}
                >
                ...
                <g onClick={() => handleClick('hambantota')}
                    onMouseEnter={() => handleMouseEnter('hambantota')}
                    onMouseLeave={handleMouseLeave}
                    style={{ cursor: 'pointer' }}
                    >
                    ...
                    <svg
                        ...
                        height="80"
                        viewBox="0 0 32 32"
                        fill={selectedRegion === 'hambantota' ? '#C7A041' : (hoveredRegion === 'hambantota' ? '#C7A041' : '#f70202')}
                        stroke={selectedRegion === 'hambantota' ? '#C7A041' : (hoveredRegion === 'hambantota' ? '#C7A041' : '#f70202')}
                        strokeWidth="2"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                    >
            ...
            <div className="absolute top-0 right-1/2 w-1/4 p-4">
                {locationData.map((location) => (
                    <InfoCard
                        ...
                        isVisible={selectedRegion === location.id}
