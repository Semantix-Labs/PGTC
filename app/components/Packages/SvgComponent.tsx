...
const SVGComponent: React.FC = () => {
    ...
    return (
        <div className='relative md:py-28 xl:py-96'>
            ...
            >
                ...
                <svg
                    ...
                    height="80"
                    viewBox="0 0 24 24"
                    fill={selectedRegion === 'colombo' ? '#C7A041' : (hoveredRegion === 'colombo' ? '#C7A041' : 'white')}
                    stroke={selectedRegion === 'colombo' ? '#C7A041' : (hoveredRegion === 'colombo' ? '#C7A041' : 'white')}
                    strokeWidth="2"
                    strokeLinecap="round"
                ...
                >
                    <svg
                        ...
                        height="80"
                        viewBox="0 0 24 24"
                        fill={selectedRegion === 'kandy' ? '#C7A041' : (hoveredRegion === 'kandy' ? '#C7A041' : 'white')}
                        stroke={selectedRegion === 'kandy' ? '#C7A041' : (hoveredRegion === 'kandy' ? '#C7A041' : 'white')}
                        strokeWidth="2"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                    >
                ...
                <g>
                    ...
                    >
                        <svg
                            ...
                            height="80"
                            viewBox="0 0 24 24"
                            fill={selectedRegion === 'Nuwaraeliya' ? '#C7A041' : (hoveredRegion === 'Nuwaraeliya' ? '#C7A041' : 'white')}
                            stroke={selectedRegion === 'Nuwaraeliya' ? '#C7A041' : (hoveredRegion === 'Nuwaraeliya' ? '#C7A041' : 'white')}
                            strokeWidth="2"
                            strokeLinecap="round"
                            strokeLinejoin="round"
                        >
                ...
                <g onClick={() => handleClick('hambantota')}
                    ...
                    <svg
                        ...
                        height="80"
                        viewBox="0 0 24 24"
                        fill={selectedRegion === 'hambantota' ? '#C7A041' : (hoveredRegion === 'hambantota' ? '#C7A041' : 'white')}
                        stroke={selectedRegion === 'hambantota' ? '#C7A041' : (hoveredRegion === 'hambantota' ? '#C7A041' : 'white')}
                        strokeWidth="2"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                    >
